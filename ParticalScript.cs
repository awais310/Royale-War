...
public class ParticalScript : MonoBehaviour
{
    ...
    public spawnmanager1 SpawnFactlist; public List<GameObject> spawnFactlist_1;
    public Rigidbody rb;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("inenemy"))
        {
            ...
            if (_enemyHealth <= 0)
            {
                ...
                Destroy(other.gameObject.transform.parent.gameObject, 0.3f);
