...
public class jetMisScript1 : MonoBehaviour
{
   ...
   // public Rigidbody rb1;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.CompareTag("inenemy") /*|| other.gameObject.CompareTag("ground")*/)
        {
            ...
            //    {
            //        gameObjectsArray1[i].gameObject.GetComponent<BoxCollider>().enabled = false;
            ...
            //    {
            //        gameObjectsArray2[i].gameObject.GetComponent<BoxCollider>().enabled = false;
            ...
            //    {
            //        gameObjectsArray3[i].gameObject.GetComponent<BoxCollider>().enabled = false;
            ...
            if (_enemyHealth <= 0)
            {
               ...
               // Destroy(other.gameObject.transform.parent.gameObject,0.5f);
                ...
                if (other.gameObject.CompareTag("inenemy") && other.gameObject.layer == LayerMask.NameToLayer("EnemyFact"))
                {
