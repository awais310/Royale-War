...
public class Enemyplayer : MonoBehaviour
{
   // public Vector3 hitPoint;
    ...
    public bool posi1, posi2, posi3, playerStand1, move, Notinradius;
    public RaycastHit hit;
    public Rigidbody rb1;
    public bool tankCheck1, carCheck1, firecheck, radiusCheck, newCheck;
    ...
    void Update()
    {
        ...
        //spawnFactlist_1 = SpawnFactlist.spawnedFactorys;
        ...
        //    {
        //        if (pos1 == true && Spawnlist.spawnedObjects1.Count > 0)
        //        {
        //            {
        ...
        //            }pos2 = true;
        //        }
        //        if (pos2 == true && Spawnlist.spawnedObjects1.Count > 1)
        //        {
        ...
        //            pos3 = true;
        //        }
        //        if (pos3 == true && Spawnlist.spawnedObjects1.Count > 2)
        //        {
    ...
    void SpawnAndMove1()
    {
        ...
        if (/*otherCollider != null  &&*/ builtSpawnPos != null && radiusCheck == true)
        {
            if (colliders.Length > 0)
            {
                foreach (Collider col in colliders)
                {
                    ...
                    if (col.gameObject != null && col.gameObject.layer == LayerMask.NameToLayer("playerNotMerge") || col.gameObject.layer == LayerMask.NameToLayer("playerFact"))
                    {
                        ...
                        GameObject builtSpawns = Instantiate(builtSpawn, builtSpawnPos.transform.position, builtSpawn.transform.rotation);
                        Rigidbody rb = builtSpawns.GetComponent<Rigidbody>();
                        Vector3 velocity = (col.gameObject.transform.position - builtSpawnPos.transform.position).normalized * 1.5f;
                        rb.velocity = velocity;
                        radiusCheck = false;
